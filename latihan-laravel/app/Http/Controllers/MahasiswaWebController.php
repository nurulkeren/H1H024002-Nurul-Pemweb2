...
class MahasiswaWebController extends Controller
{
    ...
    {
        // Mengambil data mahasiswa beserta relasi programStudi dan matakuliahs
    ...
    /**
     * Menampilkan 10 mahasiswa dengan IPK tertinggi di Teknik Komputer (Tugas No. 4)
     */
    public function topTeknikKomputer()
    {
        ...
        return view('mahasiswa.top', compact('topMahasiswa'));
    }
